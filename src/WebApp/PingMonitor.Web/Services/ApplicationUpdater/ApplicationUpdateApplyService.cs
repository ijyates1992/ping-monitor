...
internal sealed class ApplicationUpdateApplyService : IApplicationUpdateApplyService
{
    ...
    public async Task<ApplicationUpdateStagingState?> RequestApplyAsync(string requestedByUserId, CancellationToken cancellationToken)
    {
        ...
        var requestedState = new ApplicationUpdateStagingState
        {
            ...
            RequiredSchemaVersion = current.RequiredSchemaVersion,
            SchemaMetadataSource = current.SchemaMetadataSource,
            SchemaMetadataSourceName = current.SchemaMetadataSourceName,
            SchemaMetadataWarning = current.SchemaMetadataWarning,
        ...
        string? lastKnownUpdaterResultCode = null)
    {
        return new ApplicationUpdateStagingState
        {
            ...
            RequiredSchemaVersion = source.RequiredSchemaVersion,
            SchemaMetadataSource = source.SchemaMetadataSource,
            SchemaMetadataSourceName = source.SchemaMetadataSourceName,
            SchemaMetadataWarning = source.SchemaMetadataWarning,
