...
public sealed class AdminAiAssistantSettingsController : Controller
{
    ...
    private static AiToolExecutionLimits ToLimits(AiAssistantSettingsPageViewModel model) => new()
    {
        ...
        MaxStateTransitionSearchResults = model.MaxStateTransitionSearchResults,
        MaxStateTransitionLookbackDays = model.MaxStateTransitionLookbackDays,
        MaxStateTransitionEndpointDetails = model.MaxStateTransitionEndpointDetails,
    ...
    private static AiAssistantSettingsPageViewModel ToViewModel(AiAssistantSettingsDto settings, bool saved)
    {
        return new AiAssistantSettingsPageViewModel
        {
            ...
            MaxStateTransitionSearchResults = settings.ToolLimits.MaxStateTransitionSearchResults,
            MaxStateTransitionLookbackDays = settings.ToolLimits.MaxStateTransitionLookbackDays,
            MaxStateTransitionEndpointDetails = settings.ToolLimits.MaxStateTransitionEndpointDetails,
