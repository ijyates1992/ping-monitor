...
builder.Services.AddSingleton<IPowerShellPrerequisiteDetector, PowerShellPrerequisiteDetector>();
builder.Services.AddScoped<IApplicationUpdateApplyService, ApplicationUpdateApplyService>();
builder.Services.AddHostedService<ApplicationUpdateBackgroundService>();
